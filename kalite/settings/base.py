...
KHAN_CONTENT_DATABASE_PATH = os.path.join(os.path.dirname(CONTENT_DATA_PATH), "contents.sqlite")  # TODO(aron): Ask ben what the right value for this is
...
DATABASES = getattr(local_settings, "DATABASES", {
    ...
    "content_metadata": {
        "ENGINE": "django.db.backends.sqlite3",
        "NAME": KHAN_CONTENT_DATABASE_PATH,
        "OPTIONS": {
        },
    }
})
